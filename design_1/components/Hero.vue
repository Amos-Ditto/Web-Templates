            ...
            >
                <div class="col-span-2 lg:col-span-1 flex flex-col justify-center">
                    ...
                    <div class="w-full flex mt-4">
                        <button
                            type="submit"
                            class="text-white bg-[#AD9263] hover:bg-[#AD9263]/80 focus:ring-2 outline-none focus:ring-[#AD9263] font-medium rounded-lg text-base sm:text-lg tracking-wide uppercase w-auto px-6 sm:px-8 py-3 sm:py-4 transition duration-200"
                        >
                            Contact Us
                        </button>
                    </div>
